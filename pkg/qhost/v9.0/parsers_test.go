...
`
	...
	Context("ParseQhostOutput", func() {
		...
		It("should return error if output is invalid", func() {
			...
			Expect(hosts[2].Arch).To(Equal("lx-amd64"))
			Expect(hosts[2].NCPU).To(Equal(4))
			Expect(hosts[2].NSOC).To(Equal(1))
			Expect(hosts[2].NCOR).To(Equal(4))
			Expect(hosts[2].NTHR).To(Equal(4))
			Expect(hosts[2].LOAD).To(Equal(0.31))
			Expect(hosts[2].MEMTOT).To(Equal(int64(156 * 1024 * 1024 * 1024 / 10)))
			Expect(hosts[2].MEMUSE).To(Equal(int64(4229 * 1024 * 1024 / 10)))
			Expect(hosts[2].SWAPTO).To(Equal(int64(1.5 * 1024 * 1024 * 1024)))
			Expect(hosts[2].SWAPUS).To(Equal(int64(0.0)))
		})
		...
		It("should parse without issues when host is unknown", func() {
			...
			Expect(hosts[0].Name).To(Equal("global"))
			Expect(hosts[0].NCPU).To(Equal(0))
			Expect(hosts[1].Name).To(Equal("valid"))
			Expect(hosts[1].Arch).To(Equal("lx-amd64"))
			Expect(hosts[1].NCPU).To(Equal(4))
			Expect(hosts[1].NSOC).To(Equal(1))
			Expect(hosts[1].NCOR).To(Equal(4))
			...
			Expect(hosts[2].Arch).To(Equal("lx-amd64"))
			Expect(hosts[2].NCPU).To(Equal(14))
			Expect(hosts[2].NSOC).To(Equal(0))
			Expect(hosts[2].NCOR).To(Equal(0))
			Expect(hosts[2].NTHR).To(Equal(0))
			Expect(hosts[2].LOAD).To(Equal(0.0))
			Expect(hosts[2].MEMTOT).To(Equal(int64(77 * 1024 * 1024 * 1024 / 10)))
			Expect(hosts[2].MEMUSE).To(Equal(int64(0)))
			Expect(hosts[2].SWAPTO).To(Equal(int64(1.5 * 1024 * 1024 * 1024)))
			Expect(hosts[2].SWAPUS).To(Equal(int64(0.0)))
