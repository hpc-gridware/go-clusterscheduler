...
type JobOptions struct {
	...
	// request is implicitly global and hard.
	//
	// Example:
	//
	...
	// Processor Binding (v9.0 legacy: -binding [env|pe|set] exp|lin|str)
	...
	CheckpointInterval *string `flag:"ckpt_selector"`

	// Synchronization and Job Start
	NotifyBeforeSuspend *bool `flag:"-notify"`

	// Department
	Department *string `flag:"-dept"`
