...
// v9.1 configuration. Methods that use GlobalConfig reference the v9.1 type
// which includes additional fields (JsvParams, TopologyFile, MailTag,
// GDIRequestLimits, BindingParams). All other methods are identical to
// the core/v9.0 interface.
type QConf interface {
	...
	// GlobalConfig methods use v9.1 types.
